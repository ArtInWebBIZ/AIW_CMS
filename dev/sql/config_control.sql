...
('CFG_VIEW_RECONSTRUCTION_PAGE', '0', 'boolean','5'),
('CFG_MAIL_FROM', 'noreply@your-domain.com', 'string', '5'),
('CFG_REPLY_TO', 'site.owner@email.com', 'string', '5' ),
('CFG_REPLY_TO_NAME', '«AIW cms»', 'string', '5'),
('CFG_ACCOUNTANT_EMAIL', 'accountant@email.com', 'string', '5'),
('CFG_TECH_SUPPORT_USER_EMAIL', 'site.admin@email.com', 'string', '5'),
...
('CFG_DATE_TIME_FORMAT', 'd.m.Y H:i', 'string', '5'),
('CFG_DATE_TIME_SECONDS_FORMAT', 'd.m.Y H:i:s', 'string', '5'),
('CFG_DATE_TIME_MYSQL_FORMAT', 'Y-m-d H:i:s', 'string', '5'),
('CFG_SCHEMA_TIME_FORMAT', 'Y-m-d', 'string', '5'),
('CFG_CURRENCY_CODE', 'EUR', 'string', '5'),
('CFG_CURRENCY_SHORT_NAME', 'euro', 'string', '5'),
('CFG_CURRENCY_SYMBOL', '€', 'string', '5'),
('CFG_CASH_BACK_RATIO', '0.3', 'float', '5'),
('CFG_MIN_REF_CODE_LEN', '4', 'int', '5'),
('CFG_MAX_REF_CODE_LEN', '8', 'int', '5'),
('CFG_TIME_REFRESH', '300', 'int', '5'),
('CFG_SALES_DISCOUNT', '0.0', 'float', '4'),
('CFG_ENABLED_VIEW_LOG_TIME', '7889400', 'int', '5'),
('CFG_MAX_IMAGES_SIZE', '8388608', 'int', '5'),
('CFG_IMAGES_PATH', 'img', 'string', '5'),
('CFG_UPLOAD_PATH', 'upl', 'string', '5'),
('CFG_USER_AVATAR_PATH', 'avatar', 'string', '5'),
('CFG_MAX_THUMB_SIZE', '255', 'int', '5'),
('CFG_MIN_SUM_PAY_FROM_BALANCE', '500', 'int', '5'),
('CFG_ZERO_REFERRAL_USER_ID', '1', 'int', '5'),
...
('CFG_MIN_ITEM_CONTROLLER_URL_LEN', '3', 'int', '5'),
('CFG_MAX_ITEM_CONTROLLER_URL_LEN', '28', 'int', '5'),
