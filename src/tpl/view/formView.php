...
$sectionCss        = isset($v['section_css']) ? $v['section_css'] : 'content-section uk-padding-small';
$containerCss      = isset($v['container_css']) ? $v['container_css'] : '';
$overflowCss       = isset($v['overflow_css']) ? $v['overflow_css'] : ' overflow-hidden';
...
?>
<?= Content::getFormStart($sectionCss, $containerCss, $overflowCss) ?>
<?php if ($v['title'] !== null) { ?>
