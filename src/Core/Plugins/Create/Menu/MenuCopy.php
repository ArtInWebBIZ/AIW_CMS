...
class MenuCopy
{
    ...
    public static function getI(): MenuCopy
    {
            ...
            foreach ($menuList as $key => $value) {
                ...
                if ($menuList[$key]['access'] === true) {
                    ...
                    if (
                        ...
                        <tr>
                            <td>' . $iconLink . '</td>
                            <td class="color-orange">' . Trl::_($key) . '</td>
                        </tr>';
                    } else {
                        ...
                        $html .= '<tr>
                            ...
                            <td>
                                <a itemprop="url" class="menu-link" href="' . BaseUrl::getLangToLink() . $controlUrl . $actionUrl . $pageAlias . '">' . Trl::_($key) . '</a>
                            </td>
                        </tr>';
                    }
                }
            ...
            foreach ($menuList as $key => $value) {
                ...
                if ($menuList[$key]['access'] === true) {
                    ...
                    if (
                        ...
                        $html .= '<tr>
                            <td>
                                <a href="' . BaseUrl::getLangToLink() . $controlUrl . $actionUrl . $pageAlias . $get . '">
                                    <img src="' . $menuList[$key]['icon'] . '" alt="" class="icon-menu uk-margin-small-right" >
                                </a>
                            </td>
                            <td>
                                <a itemprop="url" class="menu-link" href="' . BaseUrl::getLangToLink() . $controlUrl . $actionUrl . $pageAlias . $get . '">' . Trl::_($key) . '</a>
                            </td>
                        </tr>';
                    }
                }
