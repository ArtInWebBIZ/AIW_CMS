    ...
    public function viewTicket()
    {
        ...
        if (GroupAccess::check([5])) {
            $ticketChangeStatusForm = Tpl::view(
                ForAll::contIncPath() . 'ticketChangeStatusForm.php',
        ...
        return Tpl::view(
            ...
            [
                ...
                'ticket_type'               => Type::getTypeName($this->getTicket()['ticket_type']),
                'ticket_status'             => Status::getColor($this->getTicket()['ticket_status']),
