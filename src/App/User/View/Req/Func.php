...
use Comp\User\Lib\Name\Group;
use Comp\User\Lib\Name\Status;
...
class Func
{
    ...
    private function userStatusName(): string
    {
        if (
            ...
            return Status::getColor($this->getViewedUser()['status']);
        } else {
            return '';
        }
    }
    ...
    private function getGroupName(): string
    {
        if (
            ...
            return Group::getGroupName($this->getViewedUser()['group']);
        } else {
            return '';
        }
    }
