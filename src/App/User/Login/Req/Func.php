...
use Core\{Clean, GV, Trl, Session, Auth, BaseUrl};
use Core\Modules\Msg;
use Core\Plugins\Create\Menu\Menu;
use Core\Plugins\{ParamsToSql, Ssl, Model\DB, Dll\User, View\Tpl};
    ...
    public function viewLoginForm()
    {
        return Tpl::view(
            ...
            [
                ...
                'cancel_url'          => 'hidden',
                'v_image'             => null,
                'fields'              => require PATH_APP . DS . 'User' . DS . 'Login' . DS . 'inc' . DS . 'fields.php',
