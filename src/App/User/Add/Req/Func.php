...
use Core\{BaseUrl, Config, Session, Trl};
...
class Func
{
    ...
    {
        if ($this->checkForm == []) {
            $this->checkForm = (new \Core\Plugins\Check\FormFields)->getCheckFields($this->getFieldsList());
        }
    ...
    /**
     * Get in array users register fields
     * @return array
     */
    private function getFieldsList(): array
    {
        return require ForAll::contIncPath() . 'fields.php';
    }
    /**
