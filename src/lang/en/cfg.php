...
return [
    ...
    'CFG_ACCOUNTANT_EMAIL'          => 'Email of the company\'s accountant',
    ...
    'CFG_CARD_NUMBER'               => 'Card number for payment',
    'CFG_CURRENCY_CODE'             => 'Alphabetic code of payment currency',
    'CFG_CURRENCY_SHORT_NAME'       => 'Short name of the payment currency',
    'CFG_CURRENCY_SYMBOL'           => 'Payment currency symbol',
    'CFG_CASH_BACK_RATIO'           => 'Payout ratio under the reseller program (0.3 = 30%)',
    'CFG_MINIMAL_PHOTO_PRINTS_SUM'  => 'Minimum order amount',
    ...
    'CFG_SALES_DISCOUNT'            => 'Discount factor (0.2 = 20%)',
    ...
    'CFG_UPLOAD_PATH'               => 'Name of the photo archive download directory for printers',
    'CFG_MAX_THUMB_SIZE'            => 'Maximum height and width of photo thumbnails in pixels',
    'CFG_MAX_IMAGES_IN_PHOTO_PRINT' => 'Maximum number of original photos in one order',
    'CFG_MIN_SUM_PAY_FROM_BALANCE'  => 'Minimum amount on the user\'s balance to create a withdrawal request',
    'CFG_ZERO_REFERAL_USER_ID'      => 'ID of the "zero" participant of the referral program',
    ...
    'CFG_ZERO_REFERAL_USER_ID' => 'User ID from which the reseller program starts',
