...
return [
    ...
    'INFO_USER_LASTNAME'             => '<strong>Ваше отчество</strong>.<br><br>Отчество может содержать не меньше <strong>%s</strong> и не больше <strong>%s</strong> символов.',
    'INFO_USER_SURNAME'              => '<strong>Ваша фамилия</strong>.<br><br>Фамилия может содержать не меньше <strong>%s</strong> и не больше <strong>%s</strong> символов.',
    ...
    'INFO_IF_USE_INCORRECT_EMAIL_OR_PHONE' => 'Если Вы указываете <strong>НЕ КОРРЕКТНЫЕ</strong> «Адрес электронной почты» или «Телефон» – Ваш доступ к этому сайту может быть закрыт Вами же <strong>НАВСЕГДА!<br>Администрация сайта не сохраняет приватные данные пользователей</strong>',
];
