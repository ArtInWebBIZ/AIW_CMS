...
<p>Сайт <strong>Володимира та Ольги Грязнових</strong>, надалі <em>Сайт</em>, що працює на домені <em>cms.artinweb.biz</em> та його під-доменах, використовуються файли <em>cookie</em> для забезпечення авторизації користувачів, а також перешкоджанням</em>.
