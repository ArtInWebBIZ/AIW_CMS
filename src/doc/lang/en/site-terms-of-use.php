...
<p>1.1. This User Agreement ("Agreement") applies to the "portugal-inside-out.com" website located at https://portugal-inside-out.com and to all related sites linked to https://portugal-inside-out.com.</p>
<p>1.2. The website "portugal-inside-out.com" (hereinafter referred to as the Site) is the property of Sergei Ranski.</p>
<p>1.3. This Agreement regulates the relationship between the Administration of the Site "portugal-inside-out.com" (hereinafter - the Administration of the Site) and the User of this Site.</p>
...
<p>2.2. "portugal-inside-out.com" - Website located on the domain name https://portugal-inside-out.com, operating through an Internet resource and related services.</p>
...
<p>2.4. Site Administration - authorised staff members acting on behalf of Sergei Ranski to operate this site.</p>
...
<p style="padding-left: 30px;">3.1.1. The website provides the user with the following services:</p>
<ul>
...
<p style="padding-left: 30px;">3.1.2. This Agreement shall apply to all currently available (actually functioning) Site services, as well as any subsequent modifications and additional Site services that may appear in the future.</p>
...
<p style="padding-left: 30px;">4.1.1. Modify the terms of use of the Website and change the content of this Website. The changes shall take effect as soon as the new version of the Agreement is published on the Website.</p>
<p style="padding-left: 30px;">4.1.2. Restrict access to the Site if the User breaches the terms of this Agreement.</p>
<p>4.2. The user has the right:</p>
<p style="padding-left: 30px;">4.2.1. Gain access to use the Site after complying with the registration requirements.</p>
<p style="padding-left: 30px;">4.2.2. Use all the services available on the Site and purchase any Goods, Services offered on the Site.</p>
<p style="padding-left: 30px;">4.2.3. Ask any questions relating to the services using the details found in the "Contact Us" section of the website.</p>
<p style="padding-left: 30px;">4.2.4. Use the Site only for the purposes and in the manner prescribed in the Agreement and not prohibited by the laws of Ukraine.</p>
<p>4.3. The User of this Website undertakes:</p>
<p style="padding-left: 30px;">4.3.1. Provide, at the request of the Site Administration, additional information that is directly related to the services provided on this Site.</p>
<p style="padding-left: 30px;">4.3.2. Respect the proprietary and non-proprietary rights of authors and other rights holders when using the Site.</p>
<p style="padding-left: 30px;">4.3.3. Do not take any action that could be seen as disruptive to the normal operation of the Site.</p>
<p style="padding-left: 30px;">4.3.4. Do not use the Site to disseminate any information about individuals or legal entities that is confidential and protected by European Union law.</p>
<p style="padding-left: 30px;">4.3.5. Avoid any action that could result in a breach of the confidentiality of information protected under European Union law.</p>
<p style="padding-left: 30px;">4.3.6. Do not use the Site to distribute advertising or promotional information other than with the consent of the Site Administration.</p>
<p style="padding-left: 30px;">4.3.7. Do not use the services of the website for the purpose of:</p>
<ul>
...
<p style="padding-left: 30px;">4.4.1. Use any device, programme, procedure, algorithm or method, automatic device or equivalent manual process to access, acquire, copy or monitor the content of this Site;</p>
<p style="padding-left: 30px;">4.4.2. Disrupt the proper functioning of the Site;</p>
<p style="padding-left: 30px;">4.4.3. By any means circumvent the navigational structure of the Site to obtain or attempt to obtain any information, documents or materials through any means not specifically made available through the services of this Site;</p>
<p style="padding-left: 30px;">4.4.4. Unauthorised access to the functions of the Site, any other systems or networks relating to this Site and any services offered on the Site;</p>
<p style="padding-left: 30px;">4.4.5. Violate the security or authentication system on the Site or on any network related to the Site.</p>
<p style="padding-left: 30px;">4.4.6. Perform a reverse search, trace or attempt to trace any information on any other User on the Site.</p>
<p style="padding-left: 30px;">4.4.7. Use the Site and its Contents for any purpose prohibited by EU law and to incite any illegal activity or other activity that infringes the rights or the rights of others.</p>
<h3>5. Site usage</h3>
...
<p style="padding-left: 30px;">5.5.1. The User's email address and phone number are stored in the Site's database in encrypted form using a floating key (the same value for any number of records in the database will have a different value).</p>
...
<p style="padding-left: 30px;">5.11.1. Privacy Policy;</p>
<p style="padding-left: 30px;">5.11.2. User Agreement;</p>
<p style="padding-left: 30px;">5.11.3. Terms and conditions for the use of cookies;</p>
...
<p style="padding-left: 30px;">6.2.1. Delays or failures in the transaction process due to force majeure and any case of malfunction in telecommunication, computer, electrical and other related systems.</p>
<p style="padding-left: 30px;">6.2.2. Actions of transfer systems, banks, payment systems and for delays related to their operation.</p>
<p style="padding-left: 30px;">6.2.3. The proper functioning of the Website, in the event that the User does not have the necessary technical means to use it, and has no obligation to provide users with such means.</p>
...
<p>7.2. The Site Administration may disclose any information about the User that it deems necessary to comply with applicable law or court orders, enforce the terms of this Agreement, or protect the rights or safety of Sergei Ranski and Users.</p>
<p>7.3. The Website Administration has the right to disclose information about the User if applicable Portuguese law requires such disclosure.</p>
...
<p>8.3. If the dispute cannot be resolved voluntarily, either Party may apply to the courts for the protection of its rights, which are granted to it by the Portuguese law in force.</p>
